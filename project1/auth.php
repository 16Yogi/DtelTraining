...
<body>
        ...
        <div class="form-box signup">
            ...
            <div class="form-content">
                ...
                <form id="registrationForm">
                    ...
                    <div class="input-field">
                        <input placeholder=" " id="dob" type="date" name="dob" required>
    ...
    console.log(miku);
    let errorMessageGmail = document.getElementById("error-message-gmail");
    if (email != "") {
    ...
    if (!emailPattern.test(miku)) {
        errorMessageGmail.textContent = "Please enter a valid email address.";
        errorMessageGmail.style.color = "red";
        return;
    }

    // Get the password value from the input field
    var senorita = document.getElementById("register_password").value;
    let errorMessage = document.getElementById("register-error-message-password");
    if (senorita != "") {
    ...
    var dob = document.getElementById('dob').value;
     ...
     fetch('user_registration.php', {
        headers: { // Correctly use 'headers' as an object
